...
#########################################
cd ..
wget https://github.com/wrf-model/WRF/archive/v4.1.tar.gz
mv v4.1.tar.gz WRFV4.1.tar.gz
tar -zxvf WRFV4.1.tar.gz
cd WRF-4.1
...
sed -i '154s/.*/standard_wrf_dirs="WRF-4.1 WRF WRF-4.0.3 WRF-4.0.2 WRF-4.0.1 WRF-4.0 WRFV3"/' configure
./configure
./compile
